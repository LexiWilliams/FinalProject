...
namespace FinalProject_Recipes.Models
{
    public partial class FinalDbContext : DbContext
    {
        ...
        public virtual DbSet<DietsAndRestriction> DietsAndRestriction { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AspNetUsers>(entity =>
            {
                ...
                entity.HasOne(d => d.DietNavigation)
                    ...
                    .HasConstraintName("FK__AspNetUser__Diet__1CBC4616");
            });
            ...
            modelBuilder.Entity<DietsAndRestriction>(entity =>
            {
                entity.Property(e => e.Id)
                    .HasMaxLength(50)
                    .IsUnicode(false)
            ...
            modelBuilder.Entity<FavoriteRecipes>(entity =>
            {
                ...
                entity.Property(e => e.RecipeImage).HasMaxLength(450);
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasConstraintName("FK__FavoriteR__UserI__76619304");
            });
            ...
            modelBuilder.Entity<Friends>(entity =>
            {
                ...
                entity.HasOne(d => d.Friend)
                    ...
                    .HasConstraintName("FK__Friends__FriendI__17036CC0");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.FriendsUser)
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK__Friends__UserId__160F4887");
            });
            ...
            modelBuilder.Entity<Group>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    .WithMany(p => p.GroupNavigation)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Group__UserId__625A9A57");
            });
