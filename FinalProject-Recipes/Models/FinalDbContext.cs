        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FavoriteRecipes>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasConstraintName("FK__FavoriteR__UserI__55009F39");
            });
            ...
            modelBuilder.Entity<Friends>(entity =>
            {
                ...
                entity.HasOne(d => d.Friend)
                    ...
                    .HasConstraintName("FK__Friends__FriendI__17F790F9");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.FriendsUser)
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK__Friends__UserId__17036CC0");
            });
            ...
            modelBuilder.Entity<Group>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Group__UserId__5224328E");
            });
        }
    }
}
